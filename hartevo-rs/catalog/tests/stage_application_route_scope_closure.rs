...
fn assert_contract_binding(catalog: &Catalog, scopes: &[StageApplicationRouteScope]) {
    ...
    assert_eq!(contract.contract_version, "desktop-2026-09-05-ct04-v3");
...
fn assert_foundation_and_beta_scope(scopes: &[StageApplicationRouteScope]) {
    ...
    assert_eq!(foundation.summary.implemented_handler_count, 18);
    assert_eq!(foundation.summary.not_implemented_handler_count, 11);
    ...
    assert_eq!(beta.summary.implemented_handler_count, 4);
    assert_eq!(beta.summary.not_implemented_handler_count, 18);
...
fn assert_ga_handler_scope(ga: &StageApplicationRouteScope) {
    ...
    assert_eq!(ga.summary.implemented_handler_count, 18);
    assert_eq!(ga.summary.not_implemented_handler_count, 34);
