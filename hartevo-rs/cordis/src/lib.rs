...
pub use surface::{
    ...
    ToolPostExecution, ToolsSurface, assemble_system_prompt, dispatch_tool_execution, events,
    expected_mode, finalize_tool_execution, post_tool_execution, prepare_llm_call,
    prepare_tool_execution, register_agent, register_llm_adapter, register_llm_stream,
