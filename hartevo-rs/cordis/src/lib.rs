...
pub use surface::{
    ...
    ToolExecutionPreparation, ToolsSurface, assemble_system_prompt, dispatch_tool_execution,
    events, expected_mode, prepare_llm_call, prepare_tool_execution, register_agent,
    ...
    run_tools_pipeline, stream_llm, stream_llm_request, stream_prepared_llm,
};
