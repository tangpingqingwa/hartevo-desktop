...
pub use surface::{
    ...
    ToolExecutionMode, ToolExecutionPreparation, ToolPostExecution, ToolsSurface,
    assemble_system_prompt, dispatch_tool_execution, events, expected_mode, post_tool_execution,
