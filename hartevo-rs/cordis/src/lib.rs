...
pub use surface::{
    ...
    ToolExecutionMode, ToolExecutionPreparation, ToolsSurface, assemble_system_prompt,
    dispatch_tool_execution, events, expected_mode, prepare_llm_call, prepare_tool_execution,
