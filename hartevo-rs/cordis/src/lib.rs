...
pub use agent::{
    ...
    run_agent_tool_batch_with_limit, schedule_agent_tool_calls,
};
pub use authority::{
...
pub use surface::{
    ...
    PromptSection, RuntimeSurface, SurfaceOwner, SystemPromptSurface, ToolCall, ToolDefinition,
    ToolDispatchExecution, ToolDispatchOutcome, ToolDispatchResult, ToolExecutionInput,
    ToolExecutionMode, ToolExecutionPreparation, ToolExecutionResult, ToolPostExecution,
    ToolsSurface, assemble_system_prompt, dispatch_tool_execution, events, expected_mode,
